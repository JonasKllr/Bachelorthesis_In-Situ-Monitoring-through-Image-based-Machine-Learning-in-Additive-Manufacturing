...
# camera 1
bpy.ops.object.camera_add(location = (-200.0, -400.0, 4.0), rotation = (pi/2, 0.0, pi/180 * 330))                   #camera Position auswählen
bpy.ops.object.lamp_add(type = 'POINT',location = (-23.0, -30, 25.0), rotation = (pi/2, 0.0, -pi/2))               #lamp Art und Position auswählen
...
for obj in bpy.data.objects:
    ...
    if ( obj.type =='CAMERA') and ( cameraNames == '' or obj.name.find(cameraNames) != -1) :
      ...
      bpy.data.scenes[sceneKey].render.filepath = r'C:\Users\Jonas\Documents\Studium\Bachelor\Bachelorarbeit\Skripte_Ausarbeitung\Blender\camera_' + str(c)   #Speicherpfad für neues Bild festlegen
