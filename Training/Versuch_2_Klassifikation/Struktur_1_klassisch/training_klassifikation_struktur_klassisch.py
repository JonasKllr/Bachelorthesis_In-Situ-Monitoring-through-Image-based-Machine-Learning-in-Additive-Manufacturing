...
data_dir = r'/fzi/ids/qy134/no_backup/Datensatz_Klassifikation/train'
...
cad_path_wuerfel = r'/fzi/ids/qy134/no_backup/Datensatz_Klassifikation/train/cad/Wuerfel.png'
...
fully_connected = tf.keras.layers.Dense(4, name='voll_connected')(x)      
...
log_dir = r'/fzi/ids/qy134/no_backup/Training_output_Klassifikation/Tensorboard/Date' + datetime.now().strftime("%Y%m%d-%H%M%S")
...
model.save(r'/fzi/ids/qy134/no_backup/Training_output_Klassifikation/Modell_speicher', overwrite= True)
del model
