...
cad_path_cone = r'/PATH/TO/CAD/IMAGE'
cad_path_halbkugel = r'/PATH/TO/CAD/IMAGE'
cad_path_kugel = r'/PATH/TO/CAD/IMAGE'
cad_path_pyramide = r'/PATH/TO/CAD/IMAGE'
cad_path_runddach_layershift = r'/PATH/TO/CAD/IMAGE'
cad_path_runddach = r'/PATH/TO/CAD/IMAGE'
cad_path_zuckerhut = r'/PATH/TO/CAD/IMAGE'
cad_path_zylinder = r'/PATH/TO/CAD/IMAGE'
